...
public class Missile extends com.gilvanstudios.redthebat.GameObject {

    private int speed;
    private com.gilvanstudios.redthebat.Animation animation = new com.gilvanstudios.redthebat.Animation();
